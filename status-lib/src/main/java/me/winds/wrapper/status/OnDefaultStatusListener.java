 ...
 * Data:    2018/1/17
 * Version: 1.0
 * Desc:    OnStatusListener empty implementation
 */
public abstract class OnDefaultStatusListener implements OnStatusListener {
    ...
    @Override
    public void onStatusViewHide(String status, View statusView) {

    }

    @Override
    public void onStatusViewRemove(String status, View statusView) {
